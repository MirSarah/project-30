...
function draw() {
  ...
  rectMode(CENTER);
  ground.display();
  box1.display("limegreen", "pink");
  box2.display("limegreen", "pink");
  box3.display("limegreen", "pink");
  box4.display("limegreen", "pink");
  box5.display("limegreen", "pink");
  ...
  sling.display("invisible");
  stand1.display();
  stand2.display();
  ball.display("yellow", "yellow");
  textSize(15);
  fill(0);
  text("DRAG AND RELEASE THE BALL TO DESTROY THE BOXES", 150, 380)
  fill("orange");
  textSize(15);
